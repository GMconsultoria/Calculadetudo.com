...
const App = (() => {
    ...
    function refreshAds() {
        try {
            ...
            // Inicializa CADA unidade <ins> ainda não processada
    ...
    function route() {
        ...
        if (hash === '/sobre') {
            mainContent.innerHTML = renderSobre();
            updateMeta(
                'Sobre o CalculaDeTudo | Quem somos',
                'Conheça o CalculaDeTudo: hub de calculadoras online gratuitas. Saiba quem mantém o site e como entrar em contato.',
                '/sobre'
            );
            refreshAds();
            return;
